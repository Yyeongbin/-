...
while SB == 0:
    ...
    screen.blit(text, (30, round(size[1]/2-50)))
    pygame.display.flip()
...
while SB == 0:
    ...
    if delta_time <= 60:
        screen.fill(white)
        ee = obj()
        ee.put_img("C:\py.game\낮.png")
        ee.change_size(350, 300)
        ee.x = 25
        ee.y = 200
        ee.show()
        ...
        screen.fill(black)
        nn = obj()
        nn.put_img("C:\py.game\밤.png")
        nn.change_size(150, 450)
        nn.x = 125
        nn.y = 100
        nn.show()
    ...
    if delta_time == 60:
        ...
        text_n = font.render("NEXT STAGE", True, (255,0,0))
        screen.blit(text_n, (70, round(size[1]/2-50)))
    ...
    text_time = font.render("time : {}". format(delta_time), True, (255,0,0))
...
while cc == 1:
    ...
    screen.blit(text, (125, round(size[1]/2-50)))
    pygame.display.flip()
